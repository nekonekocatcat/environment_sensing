...
object RareEnvironmentChecker {
    ...
    val environments = listOf(
        ...
        }, requireDurationMillis = 45_000, tier = 1),
        ...
        RareEnvironment("電車ラッシュレア環境", {
            it.tvoc >= 150 && it.co2 >= 1500 && it.temperature >= 25
        }, requireDurationMillis = 90_000, tier = 1),
        ...
        RareEnvironment("無響室レア環境", {
            it.noise < 10.0 && it.co2 in 400..700 && it.light in 100..400
        }, requireDurationMillis = 45_000, tier = 3),

        RareEnvironment("オーロラレア環境", {
